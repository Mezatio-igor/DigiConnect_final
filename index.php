...
// Safely get name and role from session (with default values if missing)
...
<body id="page-top">
    ...
    <a class="sidebar-brand ..." href="#">
        <div class="sidebar-brand-text">DigiConnect <sup>4.1</sup></div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="pages/schooladmin/dashboard.php">
    ...
    <!-- Future: Courses, Timetables, Teachers, etc. -->
    <?php endif; ?>

    <!-- Student only -->
    <?php if ($_SESSION['role'] == 'Student'): ?>
    <li class="nav-item">
        <a class="nav-link" href="pages/student/dashboard.php">
